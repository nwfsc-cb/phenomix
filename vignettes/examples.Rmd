...
We don't get any warnings out of the estimation, but let's look at the sdreport in more detail. This looks like things are converging.
...
```{r, fig.cap="Fitted symmetric model with tails from a  Gaussian distribution"}
...
```{r, fig.cap="Fitted asymmetric model with heavy tails from a t-distribution"}
